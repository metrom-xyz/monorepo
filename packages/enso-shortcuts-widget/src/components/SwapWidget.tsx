                ...
                <div className="relative flex flex-col gap-2.5">
                    ...
                    {displayTokenRotation && (
                        <div
                            ...
                            className="flex justify-center items-center absolute top-[43%] place-self-center rounded-full p-1 dark:bg-dark-surface bg-white hover:theme-surface-2 hover:cursor-pointer transition-colors duration-200 ease-in-out z-10"
                        >
                            <ArrowRightIcon
                                height={24}
                                width={24}
