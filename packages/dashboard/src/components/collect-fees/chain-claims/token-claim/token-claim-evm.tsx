...
type TokenClaimEvmProps = UsdPricedErc20TokenAmount;

export function TokenClaimEvm({ amount, token }: TokenClaimEvmProps) {
    ...
    const handleClaimOnClick = useCallback(() => {
        ...
        void claim();
    }, [chainData, address, token, t, amount, chainId]);
