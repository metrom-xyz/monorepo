...
<template>
    <slot></slot>
    <Teleport to="body">
        <Transition name="met_modal__fade">
            <div class="met_modal__root" v-if="props.open">
                <span ref="contentRef">
...
.met_modal__fade-enter-active,
.met_modal__fade-leave-active {
    @apply transition-opacity duration-200 ease-in-out;
}

.met_modal__fade-enter-from,
.met_modal__fade-leave-to {
    @apply opacity-0;
}
</style>
