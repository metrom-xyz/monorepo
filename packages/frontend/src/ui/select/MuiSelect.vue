...
import MuiChrevronUpIcon from "../../icons/ChrevronUpIcon.vue";
import MuiChevronDownIcon from "../../icons/ChevronDownIcon.vue";
...
import MuiSelectRow from "./row/MuiSelectRow.vue";
...
<template>
    <div class="mui_select__root" ref="root">
        <MuiPopover :open="open" placement="bottom-start" :offset="8">
            ...
            <MuiTextInput
                ...
                actionRight
                :icon="$props.icon"
                :action="open ? MuiChrevronUpIcon : MuiChevronDownIcon"
                @click="open = !open"
                @input="handleQueryOnChange($event.target.value)"
                class="mui_select__input"
            />
            <template #popover>
                <div
                    ref="dropdownRef"
                ...
                >
                    <div
                        class="mui_select__list__wrapper"
                    ...
                    >
                        ...
                        <div v-else class="mui_select__empty__list">
                            <MuiTypography>
...
.mui_select__empty__list {
    @apply flex justify-center items-center p-3 h-12;
}

.mui_select__list__wrapper {
    @apply w-full
        h-full
        max-h-48
        rounded-lg
