...
import MuiDatePicker from "./MuiDatePicker.vue";
import MuiDateTimeWheel from "./MuiDateTimeWheel.vue";
...
<template>
    <div class="mui_date_input__root">
        <MuiPopover :open="open" :placement="'bottom'">
            <MuiTextInput
                v-model="dateText"
            ...
            />
            <template #popover>
                <div ref="pickerRef" class="mui_date_input__picker__container">
                    <MuiDatePicker
                        v-model="dateModel"
                        :min="$props.min"
                        :max="$props.max"
...
<style>
.mui_date_input__root {
    @apply w-full;
}

.mui_date_input__picker__container {
    @apply flex w-fit;
}
</style>
