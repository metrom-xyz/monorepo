...
let addressesFile =
    '// this file is automatically generated by the /scripts/prepare-deploy.ts\n// script, do not edit this manually\n\nimport { Address } from "@graphprotocol/graph-ts";\n\n';
addressesFile += `export const DEBT_TOKEN_ADDRESS = Address.fromString("${contracts.DebtToken.address}");\n`;
...
try {
    ...
    writeFileSync(
        ...
        Mustache.render(
            ...
            {
                network,
                debtTokenAddress: contracts.DebtToken.address,
                debtTokenStartBlock: contracts.DebtToken.startBlock,
            },
        ),
    );
